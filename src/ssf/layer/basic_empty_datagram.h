#ifndef SSF_LAYER_BASIC_EMPTY_DATAGRAM_H_
#define SSF_LAYER_BASIC_EMPTY_DATAGRAM_H_
...
#include "ssf/layer/receive_from_op.h"
...
#endif  // SSF_LAYER_BASIC_EMPTY_DATAGRAM_H_
